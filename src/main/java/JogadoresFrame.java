...
public class JogadoresFrame extends JFrame {
    ...
    private JPanel criarConteudo() {
        ...
        RoundedButton verPerfil = new RoundedButton("Ver Perfil", BLUE, Color.WHITE);
        verPerfil.addActionListener(e -> abrirSelecionado());

        RoundedButton alternar = new RoundedButton("Ativar / Inativar", RED, Color.WHITE);
        alternar.addActionListener(e -> alternarSelecionado());
    ...
    private JPanel criarCardTabela() {
        ...
        String[] colunas = {"Nome", "Equipa", "Posição", "Nº", "Idade", "Golos", "Assist.", "Cartões", "Estado"};
    ...
    private void atualizarTabela() {
        ...
        for (Jogador j : jogadores) {
            modelo.addRow(new Object[]{
                    j.getNome(), j.getEquipa(), j.getPosicao(), j.getNumero(), j.getIdade(),
                    j.getGolos(), j.getAssistencias(), j.getCartoes(), j.getEstadoTexto()
            });
        }
    }
    ...
    private Jogador jogadorSelecionado() {
        ...
        return jogadores.get(tabela.convertRowIndexToModel(linha));
    }
    ...
    private List<Jogador> criarJogadoresDemo() {
        ...
        lista.add(new Jogador("Cristiano Ronaldo", 7, "Avançado", 83, 1.87, "Direito",
                LocalDate.of(1985, 2, 5), "Portugal", "Funchal, Madeira", "Portugal", "Grupo A",
                "Top marcador", 8, 8, 2, 1, 720, 86, 74, 92, true));
        lista.add(new Jogador("Pedro Lima", 4, "Defesa", 83, 1.88, "Direito",
                LocalDate.of(2000, 1, 20), "Brasil", "São Paulo", "Leiria FC", "Grupo A",
                "Mais cartões", 2, 1, 1, 3, 650, 52, 53, 61, true));
        lista.add(new Jogador("Rafa Silva", 27, "Avançado", 66, 1.72, "Direito",
                LocalDate.of(1993, 5, 17), "Portugal", "Vila Franca de Xira", "Benfica", "Grupo B",
                "Mais assistências", 7, 8, 4, 1, 610, 81, 88, 79, true));
        lista.add(new Jogador("Otávio Monteiro", 25, "Médio", 65, 1.72, "Direito",
                LocalDate.of(1995, 2, 9), "Portugal", "João Pessoa", "FC Porto", "Grupo C",
                "Criador de jogo", 8, 4, 7, 1, 690, 69, 91, 85, true));
        lista.add(new Jogador("Bruno Lourenço", 12, "Guarda-Redes", 85, 1.90, "Direito",
                LocalDate.of(1998, 3, 21), "Portugal", "Porto", "Boavista", "Grupo D",
                "Suplente", 2, 0, 0, 1, 180, 35, 50, 76, false));
        return lista;
    }
}
